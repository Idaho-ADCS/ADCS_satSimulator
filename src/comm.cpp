#include "Arduino.h"  //needed for debug serial.write()
...
void init_uart(void)
{
	MySerial.begin(115200, SERIAL_8O1, 16, 17);
	/*
	const uart_config_t uart_config = {
        ...
        //.source_clk = UART_SCLK_APB,   //this was originally not commented out, some error of versions must be present
		//https://community.platformio.org/t/platformio-with-esp32-uart-h-does-not-match-esp-documentation/23204
    };
...
int send_command(uint8_t cmd)
{
	...
	const int txBytes = MySerial.write(packet._data, len);  //this line modified data type of second argument
